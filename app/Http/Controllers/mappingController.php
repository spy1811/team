...
class mappingController extends Controller
{
    ...
    {
         $mappimg=DB::table('mapping_driver_vehicles')->join('drivers','drivers.id','=','mapping_driver_vehicles.id_driver')->join('vehicle_fleets','vehicle_fleets.id','=','mapping_driver_vehicles.id_vehicle')->get();
